        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:pt-[90px]">
            ...
            <ul className="space-y-2 md:space-y-3 text-[14px] md:text-[16px] font-medium text-[#3D3D3D] leading-relaxed">
              ...
              <li><Link href="/placement">Placement Assistance</Link></li>
          ...
          <div className="lg:pt-[90px]">
            ...
            <ul className="space-y-2 md:space-y-3 text-[14px] md:text-[16px] font-medium text-[#3D3D3D] leading-relaxed">
              ...
              <li>
                <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <li>
                <a href="https://discord.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
